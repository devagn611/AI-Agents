...
if "vector" not in st.session_state:
    ...
    text = "nn".join([doc.page_content for doc in st.session_state.docs])
...
Also Provide response in the step by step format.
also use your reasoning ability to answer the question.
